...
#ifndef LLVM_LIB_TRANSFORMS_INSTCOMBINE_CANONICALIZATIONINTERNAL_H
#define LLVM_LIB_TRANSFORMS_INSTCOMBINE_CANONICALIZATIONINTERNAL_H
...
/// combine them.
class LLVM_LIBRARY_VISIBILITY Canonicalizer
    : public InstVisitor<Canonicalizer, Instruction *> {
...
public:
  Canonicalizer(CanonicalizationWorklist &Worklist, BuilderTy &Builder,
