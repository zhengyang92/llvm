...
void PassManagerBuilder::addInstructionCombiningPass(
  ...
  //PM.add(createCanonicalizationLegacyPass(ExpensiveCombines));
}

void PassManagerBuilder::addCanonicalizationLegacyPass(
    legacy::PassManagerBase &PM) const {
  bool ExpensiveCombines = OptLevel > 2;
  //PM.add(createInstructionCombiningPass(ExpensiveCombines));
  PM.add(createCanonicalizationLegacyPass());
}
...
void PassManagerBuilder::addPGOInstrPasses(legacy::PassManagerBase &MPM) {
  ...
  if (OptLevel > 0 && SizeLevel == 0 && !DisablePreInliner &&
    ...
    MPM.add(createCanonicalizationLegacyPass());
...
void PassManagerBuilder::addFunctionSimplificationPasses(
  ...
  MPM.add(createCFGSimplificationPass());     // Merge & remove BBs
  // Combine silly seq's
  addCanonicalizationLegacyPass(MPM);
...
void PassManagerBuilder::addLTOOptimizationPasses(legacy::PassManagerBase &PM) {
  ...
  addCanonicalizationLegacyPass(PM);
